...
function Evaluation({ teams, horsUpTeams, showToast, filtreAnnee, filtreSemestre }) {
  ...
  useEffect(() => {
    if (!teamId) return
    getScores({ sous_equipe: teamId, type: teamType }).then(setScores).catch((err) => console.error(err))
    loadGrille()
  }, [teamId, teamType, loadGrille])
  ...
  return (
    <>
      ...
      <div className="grid-2" style={{ marginBottom: 16 }}>
        ...
        <div className="card" style={{ marginBottom: 0 }}>
          <div className="card-head">
            <div><h2>Scores calculés</h2><div className="hint">Semestre 2 · 2025/2026</div></div>
            <select
